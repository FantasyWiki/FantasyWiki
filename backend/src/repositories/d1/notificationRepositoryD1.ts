...
// credits comes from the team_credits view (ADR 0007), which states the
// derivation once. This fragment takes no bind params of its own — callers
// supply only their own WHERE params.
