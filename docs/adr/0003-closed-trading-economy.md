...
- `docs/domain/scoring-system.md` §6.2/§6.3 (stipend, fee, wealth ceiling figures) needs updating to match: not yet done as of this ADR. The **wealth ceiling** concept (~2,400 credits under the old model)
