...
| [0004 Scoring Engine Platform](../docs/adr/0004-scoring-engine-platform.md) | **Held**, with the scheduler and the delivery path revised during implementation. Free, and both failures were the project's own code rather than the platform. |
