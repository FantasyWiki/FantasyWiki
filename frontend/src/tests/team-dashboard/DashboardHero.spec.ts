 ...
 *
 * Covers: identity display, featured-card carousel, rank pill, navigation.
 * Bell button / inbox / trade-proposal tests live in InBox.spec.ts.
 *
 * Environment notes:
 * - Ionic components are web-component stubs in jsdom.
 ...
 * - Each navigation test gets its own router instance to avoid cross-test
 *   route state pollution.
 */
