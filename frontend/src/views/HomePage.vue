<template>
  <nav-bar>
    ...
    <p class="ion-margin-horizontal ion-padding-horizontal">
      Draft Wikipedia articles, earn points from real search trends, and compete
      in weekly tournaments. The ultimate fantasy game for the curious mind.
    </p>
    <ion-item-group
      class="ion-margin-horizontal ion-padding-horizontal ion-display-flex ion-justify-content-center"
    >
      <ion-searchbar
        :animated="true"
        placeholder="Search articles... (e.g., Bitcoin, AI)"
        color="light ion-text-start"
      ></ion-searchbar>
    ...
    <ion-item-group
      class="ion-display-flex ion-justify-content-center ion-flex-wrap ion-padding-vertical"
    >
      <section
